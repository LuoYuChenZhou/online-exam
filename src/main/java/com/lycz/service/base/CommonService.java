...
public interface CommonService {
    ...
    /**
     * 发送消息到ActiveMQ中【仅发送消息】
     */
    void sendActiveMQMessage(String type, String Message, String token);

    /**
     * 发送建立/移除考生考官关系
     *
     * @param type 类型（建立-add,移除-remove）
     */
    void sendErEeAMQMessage(String message, String erId, String eeId, String type);
}
